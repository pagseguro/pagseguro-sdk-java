...
/**
 * Converter for V2 Transaction Cancellation
 *
 * @author PagSeguro Internet Ltda.
 */
public class TransactionCancellationV2MapConverter extends
    AbstractMapConverter<TransactionIdentify> {

  private static final ParameterV2MapConverter PARAMETER_MC = new ParameterV2MapConverter();

  TransactionCancellationV2MapConverter() {
  }

  /**
   * Convert the interface for transaction cancellation on a request map
   *
   * @param requestMap          Request Map used to pass params to api
   * @param transactionIdentify Interface for Transaction Identify
   * @see RequestMap
