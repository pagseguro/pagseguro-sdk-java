...
/**
 * Pagseguro prod environment
 *
 * @author PagSeguro Internet Ltda.
 */
public class PagSeguroProdEnv extends PagSeguro {
   ...
   */
  PagSeguroProdEnv(HttpClient httpClient, Credential credential) {
  ...
  public String toString() {
    return "pagseguro-production-env";
  }
