...
/**
 * Interface for direct pre approval data list, used in searches to list many results.
 *
 * @param <T> Class that will be listed
 * @author PagSeguro Internet Ltda.
 */
public interface DirectPreApprovalDataList<T> extends Iterable<T> {
