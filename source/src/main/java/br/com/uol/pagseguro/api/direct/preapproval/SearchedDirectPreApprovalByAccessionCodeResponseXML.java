...
/**
 * Implementation of {@code SearchedDirectPreApprovalByAccessionCode} and {@code XMLUnmarshallListener}
 *
 * @author PagSeguro Internet Ltda.
 */
@XmlRootElement(name = "preApproval")
public class SearchedDirectPreApprovalByAccessionCodeResponseXML implements SearchedDirectPreApprovalByAccessionCode, XMLUnmarshallListener {
    ...
    SearchedDirectPreApprovalByAccessionCodeResponseXML() {
    }
