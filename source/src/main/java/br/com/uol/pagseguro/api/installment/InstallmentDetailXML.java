...
/**
 * Implementation of {@code InstallmentDetail}
 *
 * @author PagSeguro Internet Ltda.
 */
public class InstallmentDetailXML implements InstallmentDetail {
  ...
  public String toString() {
    return "InstallmentCheckoutDetailXML{" +
        "cardBrand='" + cardBrand + '\'' +
        ", quantity=" + quantity +
        ", amount=" + amount +
