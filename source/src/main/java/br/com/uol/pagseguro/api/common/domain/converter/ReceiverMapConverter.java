 ...
 */
public class ReceiverMapConverter extends AbstractMapConverter<Iterable<? extends Receiver>> {
  ...
  protected void convert(RequestMap requestMap, Iterable<? extends Receiver> receivers) {
    ...
    for (Receiver receiver : receivers) {
      String receiverEmail = String.format("receiver.", i);
      requestMap.putString(receiverEmail.concat("email"), receiver.getEmail());
      i++;
    }
