...
public class TransactionSearchByNotificationTest extends Resource4Test {

  private TransactionSearchByNotification transactionSearchByNotification;

  @Before
  public void setUp() throws Exception {
    transactionSearchByNotification = new TransactionSearchByNotification("code");
  }
  ...
  public void shouldSearch() throws Exception {
    ...
    assertEquals("code2", transactionDetail.getCode());
  ...
  public void shouldThrowsBadRequest() {
    try {
      String responseAsString = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
                                ...
                                "<error>" +
                                "<code>0001</code>" +
                                "<message>Transaction notification code is required.</message>" +
                                "</error>" +
                                "</errors>";
      ...
      assertEquals("Transaction notification code is required.", error.getMessage());
    } catch (Exception e) {
    }
  }
