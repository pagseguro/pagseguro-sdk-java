...
public class PreApprovalSearchByNotificationTest extends Resource4Test {
  ...
  public void setUp() throws Exception {
    preApprovalSearchByNotification = new PreApprovalSearchByNotification("code");
  }
  ...
  public void shouldSearch() throws Exception {
    ...
    PreApprovalDetail preApprovalDetail = preApprovalSearchByNotification.execute(pagSeguro, httpClient);

    DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

    assertEquals("name", preApprovalDetail.getName());
    assertEquals("code 2", preApprovalDetail.getCode());
  ...
  public void shouldThrowsBadRequest() {
    try {
      ...
      preApprovalSearchByNotification.execute(pagSeguro, httpClient);
