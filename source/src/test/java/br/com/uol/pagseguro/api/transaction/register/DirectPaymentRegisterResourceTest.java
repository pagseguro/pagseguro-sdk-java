...
public class DirectPaymentRegisterResourceTest extends Resource4Test {

  private DirectPaymentRegisterResource directPaymentRegisterResource;
  ...
  public void setUp() {
    ...
    directPaymentRegistration = new DirectPaymentRegistrationBuilder()
        ...
        .withReceiverEmail("receiver@receiver.com")
        ...
        .withShipping(new ShippingBuilder()
            ...
            .withAddress(new AddressBuilder()
                ...
                .withNumber("9999")
                .withStreet("Av. PagSeguro"))).build();

    directPaymentRegisterResource = new DirectPaymentRegisterResource(pagSeguro, httpClient, directPaymentRegistration);
  ...
  public void shouldCreditCardRegister() throws IOException, ParseException {
    ...
    TransactionDetail transactionDetail = directPaymentRegisterResource.withCreditCard(creditCard);
    assertTransaction(transactionDetail);
  }
