 ...
 */
public class CreateDirectPaymentWithInternationalCreditCard {
  ...
  public static void main(String[] args) {
    try {
      ...
      // Checkout transparente (pagamento direto) cartao de credito internacional
      TransactionDetail internationalCreditCardTransaction =
          ...
          ).withInternationalCreditCard(new CreditCardBuilder()
      ...
      System.out.println(internationalCreditCardTransaction);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
