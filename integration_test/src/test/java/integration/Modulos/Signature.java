	    	...
	    	RegisteredPreApproval registeredPreApproval = pagSeguro.preApprovals().register(
	                new PreApprovalRegistrationBuilder()
	                	...
	                	.withPreApproval(new PreApprovalRequestBuilder()
	                		...
	                		.withDetails("Todo dia 28 ser� cobrado o valor de R$100,00 referente ao seguro contra roubo do Notebook Prata")
...
//				WebDriver driver = new ChromeDriver();
	...
	// INFORMAR CAMINHO ONDE EST� O ARQUIVO PHANTOMJS.EXE
...
//Cenario: Criar requisicoes de cobran�a de assinaturas
//Dado que esteja autenticado na api do pagseguro
		  ...
		  try {
		    	...
		    	ChargedPreApproval preApprovalCobranca = pagSeguro.preApprovals().charge(new PreApprovalChargingBuilder().addItem(new PaymentItemBuilder()
		    												...
		    												.withQuantity(2)
		    												 ...
		    												 .withCode(capturar_codigo_assinatura_e_ativar()) //ASSINATURA TEM QUE ESTAR PAGA E S� PODE SER FEITO UMA VEZ
		    			);
...
//		  Cenario: Consultar assinaturas por c�digo de notificacao invalida
